...
const App = () => {
  const [models, setModels] = useState([
    ...
    },
    {
      ...
      images: [
        'https://placehold.co/400x500/9B59B6/FFFFFF?text=بلوزة+كاجوال+1',
        'https://placehold.co/400x500/B377D1/FFFFFF?text=بلوزة+كاجوال+2',
        'https://placehold.co/400x500/7D3F98/FFFFFF?text=بلوزة+كاجوال+3'
      ],
      price: 55000,
      sizes: ['M', 'L', 'XL'],
      colors: [
        { name: 'بنفسجي', available: true, quantity: 10 },
        { name: 'أحمر داكن', available: true, quantity: 7 },
        { name: 'أزرق غامق', available: false, quantity: 0 }
      ],
      description: 'بلوزة كاجوال عصرية تناسب جميع المناسبات'
    },
    {
      id: 5,
      name: 'بنطلون جينز مودرن',
      images: [
        'https://placehold.co/400x500/3498DB/FFFFFF?text=جينز+1',
        'https://placehold.co/400x500/5DAAE0/FFFFFF?text=جينز+2',
        'https://placehold.co/400x500/2980B9/FFFFFF?text=جينز+3'
      ],
      price: 38000,
      sizes: ['28', '30', '32', '34', '36'],
      colors: [
        { name: 'أزرق فاتح', available: true, quantity: 12 },
        { name: 'أزرق غامق', available: true, quantity: 15 },
        { name: 'أسود', available: false, quantity: 0 }
      ],
      description: 'بنطلون جينز بقصة عصرية ومريحة'
    },
    {
      id: 6,
      name: 'فستان سهرة فاخر',
      images: [
        'https://placehold.co/400x500/E74C3C/FFFFFF?text=سهرة+1',
        'https://placehold.co/400x500/EC7063/FFFFFF?text=سهرة+2',
        'https://placehold.co/400x500/C0392B/FFFFFF?text=سهرة+3'
      ],
      price: 85000,
      sizes: ['S', 'M', 'L'],
      colors: [
        { name: 'أحمر', available: true, quantity: 5 },
        { name: 'ذهبي', available: true, quantity: 3 },
        { name: 'فضي', available: false, quantity: 0 }
      ],
        ...
        {models.length === 0 && (
          <div className="text-center py-20">
            <div className="bg-white rounded-3xl shadow-2xl p-12 max-w-md mx-auto">
              ...
              <h3 className="text-3xl font-bold text-gray-800 mb-4">لا توجد منتجات حالياً</h3>
              <p className="text-xl text-gray-600">نعمل على تحديث المخزون، يرجى العودة لاحقاً</p>
            </div>
          </div>
        )}
      </div>
